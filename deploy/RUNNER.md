...
- 当前服务器 Docker Root Dir 固定为 `/data/docker`，不要回退到系统盘 `/var/lib/docker`。
- 当前三仓 runner 工作目录固定为：
...
sudo mkdir -p /data/github-runner/cloud /srv/iiot-cloud/deploy /srv/iiot-cloud/deploy/certs
sudo chown -R github-runner:github-runner /data/github-runner/cloud /srv/iiot-cloud/deploy
```
