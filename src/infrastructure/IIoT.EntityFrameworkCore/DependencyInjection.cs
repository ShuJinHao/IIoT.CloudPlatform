...
public static class DependencyInjection
{
    public static void AddEfCore(this IHostApplicationBuilder builder)
    {
        ...
        builder.Services.AddSingleton<HumanSessionTokenExchangeProcessGate>();
        ...
        builder.Services.AddScoped<IDeviceClientOverviewQueryService, QueryServices.DeviceClientOverviewQueryService>();
