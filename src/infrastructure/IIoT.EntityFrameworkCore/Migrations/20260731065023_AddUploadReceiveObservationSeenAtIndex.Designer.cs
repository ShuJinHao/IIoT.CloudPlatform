...
namespace IIoT.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260731065023_AddUploadReceiveObservationSeenAtIndex")]
    partial class AddUploadReceiveObservationSeenAtIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IIoT.Core.Production.Aggregates.ClientReleases.ClientReleaseComponentDeletion", b =>
                {
                    ...
                    b.Property<string>("CleanupResultJson")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("IIoT.Core.Production.Aggregates.ClientReleases.ClientReleaseVersion", b =>
                {
                    ...
                    b.Property<string>("DeletionReceiptJson")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("IIoT.Core.Production.Aggregates.ClientReleases.DeviceClientState", b =>
                {
                    ...
                    b.Property<DateTime?>("PlcSnapshotReportedAtUtc")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("IIoT.EntityFrameworkCore.Uploads.UploadReceiveObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("RegistrationId")
                        .HasDatabaseName("ix_upload_receive_observations_registration_id");

                    b.HasIndex("SeenAtUtc")
                        .HasDatabaseName("ix_upload_receive_observations_seen_at_utc");

                    b.ToTable("upload_receive_observations", (string)null);
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.InboxState", b =>
                {
                    ...
                    b.ToTable("integration_event_inbox_states", (string)null);
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxMessage", b =>
                {
                    ...
                    b.ToTable("consumer_outbox_messages", (string)null);
                });
            ...
            modelBuilder.Entity("MassTransit.EntityFrameworkCoreIntegration.OutboxState", b =>
                {
                    ...
                    b.ToTable("consumer_outbox_states", (string)null);
                });
            ...
            modelBuilder.Entity("IIoT.EntityFrameworkCore.Uploads.UploadReceiveObservation", b =>
                {
                    b.HasOne("IIoT.EntityFrameworkCore.Uploads.UploadReceiveRegistration", null)
                        .WithMany()
