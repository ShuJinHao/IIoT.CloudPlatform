...
public sealed class RepositoryConfigurationBoundaryTests
{
    ...
    public void HostConfigurations_ShouldDefineRequiredHardeningAndInfrastructureSections()
    {
        ...
        httpApi.GetValue<bool>("Infrastructure:Postgres:EnableRetry").Should().BeTrue();
        httpApi.GetValue<int>("Infrastructure:Postgres:MaxRetryCount").Should().BeGreaterThan(0);
        ...
        dataWorker.GetValue<bool>("Infrastructure:Postgres:EnableRetry").Should().BeTrue();
        dataWorker.GetValue<int>("Infrastructure:Postgres:MaxRetryCount").Should().BeGreaterThan(0);
        ...
        migration.GetValue<bool>("Infrastructure:Postgres:EnableRetry").Should().BeTrue();
        migration.GetValue<int>("Infrastructure:Postgres:MaxRetryCount").Should().BeGreaterThan(0);
