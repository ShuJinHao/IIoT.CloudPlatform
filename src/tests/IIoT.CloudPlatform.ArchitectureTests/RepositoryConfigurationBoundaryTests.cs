...
public sealed class RepositoryConfigurationBoundaryTests
{
    ...
    public void HostConfigurations_ShouldDefineRequiredHardeningAndInfrastructureSections()
    {
        ...
        httpApi.GetValue<int>("OidcProvider:AuthorizationCodeLifetimeMinutes").Should().BeGreaterThan(0);
        httpApi.GetValue<int>("OidcProvider:SessionIdleMinutes").Should().BeGreaterThan(0);
